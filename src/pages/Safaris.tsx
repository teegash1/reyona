...
const lodgeDetailsMap: Record<string, LodgeDetail> = lodgeDetailsData.reduce((acc, entry) => {
  ...
  const tanzaniaPackages = [
    ...
    },
    {
      ...
      price: '$6,084',
      image: 'https://abundadiscoveriesuganda.com/wp-content/uploads/2025/01/Ngorongoro-National-Park-Tanzania-by-Licious-Adventure-%E2%80%94-YouPic.jpg',
    ...
    },
    {
      ...
      price: '$6,455',
      image: 'https://c.ekstatic.net/ecl/destinations/africa/zanzibar/aerial-view-zanzibar-beach-resort-pier-pb-m480x480.jpg',
